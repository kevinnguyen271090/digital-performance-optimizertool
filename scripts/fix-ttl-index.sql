...
-- 4. Tạo function để cleanup sessions cũ (thay vì dùng TTL index)
...
-- 5. Tạo function tổng hợp để cleanup tất cả dữ liệu cũ
...
-- 6. Tạo function để tổng hợp dữ liệu từ analytics_data sang hourly_aggregates
...
-- 7. Tạo function để tổng hợp từ hourly sang daily
...
-- 9. Tạo function để generate AI insights
...
-- 10. Tạo function để check performance thresholds
...
-- 11. Tạo scheduled function để chạy định kỳ
